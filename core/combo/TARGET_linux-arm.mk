...
$(combo_2nd_arch_prefix)TARGET_thumb_CFLAGS := -mthumb $(ARCHIDROID_GCC_CFLAGS_THUMB) -fomit-frame-pointer
else
$(combo_2nd_arch_prefix)TARGET_thumb_CFLAGS := -mthumb $(ARCHIDROID_GCC_CFLAGS_THUMB) -fomit-frame-pointer -fno-strict-aliasing
endif
